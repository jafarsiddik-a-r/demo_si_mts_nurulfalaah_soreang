                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="judul" id="judul" value="{{ old('judul') }}" required maxlength="255"
                                class="w-full border-2 border-gray-200 dark:border-slate-600 px-3 py-1.5 text-base bg-white
                                dark:bg-slate-900 text-slate-900 dark:text-white focus:border-green-600 focus:outline-none
                                rounded" placeholder="Masukan Judul Video">
                        </div>
                        @error('judul')
