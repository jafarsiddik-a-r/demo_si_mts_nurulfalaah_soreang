    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Isi formulir berikut untuk mempublikasikan
                    informasi di website utama.</p>
            </div>
        ...
        <form action="{{ route(($type === 'artikel') ? 'cpanel.artikel.store' : 'cpanel.berita.store') }}" method="POST"
            enctype="multipart/form-data" id="create-form" data-notify="loading"
