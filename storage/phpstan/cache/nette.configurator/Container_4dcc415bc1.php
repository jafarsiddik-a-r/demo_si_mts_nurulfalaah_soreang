...
class Container_4dcc415bc1 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_4dcc415bc1 $container)
			{
	...
	public function createServiceContainer(): Container_4dcc415bc1
	{
		return $this;
	}
