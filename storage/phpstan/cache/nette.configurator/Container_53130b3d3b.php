...
class Container_53130b3d3b extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_53130b3d3b $container)
			{
	...
	public function createServiceContainer(): Container_53130b3d3b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => 'C:\Project\mts-nurul-falaah-soreang\phpstan-baseline.neon',
			'usedLevel' => '6',
