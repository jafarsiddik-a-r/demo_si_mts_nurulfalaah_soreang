...
class Container_49320ed4f8 extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_49320ed4f8 $container)
			{
	...
	public function createServiceContainer(): Container_49320ed4f8
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'AHA_CHROME_CRASHPAD_PIPE_NAME' => '\\\.\pipe\crashpad_55436_BZMDECSUUHCYIQWU',
				'AI_AGENT' => 'TRAE',
				...
				'SAFE_RM_PROTECTION_FLAG' => 'C:/users/difarcy/appdata/local/temp/safe-rm-protection-flag-db935c5c-5c14-4879-8eed-30c88e502fdf',
				'SAFE_RM_SOURCE_FLAG' => 'C:/users/difarcy/appdata/local/temp/safe-rm-source-flag-0b064d92-d14f-48ad-8259-43b7ea49c296',
				...
				'TRAE_SANDBOX_CONFIG_NAME' => '6964709fa95595844ab62282',
				'TRAE_SANDBOX_SOURCE_FLAG_PATH' => 'C:/users/difarcy/appdata/local/temp/sandbox-source-flag-d5c126e2-d5cd-4f98-9c98-86a128073bdf',
